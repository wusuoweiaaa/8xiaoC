 ...
 * @Author       : WuWei
 * @LastEditors  : WuWei
 * @Date         : 2021-04-25 21:00:09
 * @LastEditTime : 2021-04-27 20:57:28
 * @FilePath     : /8xiaoC/src/views/water-cert/detail.vue
...
<template>
  <div class="app-container">
    ...
    <el-row class="detail-item">
     ...
     <el-row class="detail-item">
      <el-col :span="8" class="item-name">许可范围:</el-col>
      <el-col :span="16" class="item-value">{{detail.licenseScope}}</el-col>
    </el-row>
     <el-row class="detail-item">
    ...
    <el-button
        ...
        >修改已填报供水单位卫生许可证</el-button
      >
  </div>
</template>

<script>
import { getWaterHygieneCertDetail } from "@/api/cert";
export default {
  data() {
    return {
      loading:false,
