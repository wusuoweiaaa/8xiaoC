 ...
 * @LastEditTime : 2021-04-27 21:16:00
 * @FilePath     : /8xiaoC/src/views/public-hygienic/index.vue
...
<script>
import {
  postPublicHygienicReport,
  putPublicHygienicReportId,
  getPublicHygienicReportDetail,
} from "@/api/cert";
...
export default {
  ...
  mounted() {
    if (this.$route.params && this.$route.params.id) {
      getPublicHygienicReportDetail(this.$route.params.id).then((res) => {
  ...
  methods: {
    ...
    submitHandle(data) {
      return this.$route.params.id
        ? putPublicHygienicReportId(this.$route.params.id, data)
        : postPublicHygienicReport(data);
    },
    onCancel() {
