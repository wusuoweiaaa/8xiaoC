 ...
 * @LastEditTime : 2021-04-27 21:16:08
 * @FilePath     : /8xiaoC/src/views/public-hygienic/detail.vue
...
<template>
  <div class="app-container">
    ...
    <el-button
        ...
        >修改已填公共用品卫生检测报告</el-button
      >
  </div>
</template>

<script>
import { getPublicHygienicReportDetail } from "@/api/cert";
export default {
  data() {
    return {
      loading:false,
