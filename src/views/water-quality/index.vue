 ...
 * @LastEditTime : 2021-04-27 21:14:15
 * @FilePath     : /8xiaoC/src/views/water-quality/index.vue
...
<script>
import {
  postWaterQualityReport,
  putWaterQualityReportId,
  ...
  methods: {
    ...
    submitHandle(data) {
      return this.$route.params.id
        ? putWaterQualityReportId(this.$route.params.id, data)
        : postWaterQualityReport(data);
    },
    onCancel() {
